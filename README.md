...
3. Avvia il wizard `scripts/proxmox-lxc-install.sh` (CTID, hostname, risorse, **bridge di rete** / VLAN, DHCP o IP statico, privilegi, password root, installazione opzionale di DA-INVENT nel CT)
