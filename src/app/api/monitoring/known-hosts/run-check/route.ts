...
export async function POST(request: Request) {
  // withTenantFromSession (fix C3 2026-06-23): senza, runKnownHostCheck→getDb()
  // cadeva sul DEFAULT.db → un tenant non-DEFAULT verificava il DB sbagliato e
  // riceveva {success:true} mentre i suoi host non venivano mai controllati.
